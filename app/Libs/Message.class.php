	...
	*/
	static function setResponseInfo($errorkey , $data = '' , $code = '0001' , $msg = '未知错误' ){
			...
			$error =  array(
				...
				'NAV_GOODS_EMPTY'				=> array('code'=>'4024' , 'msg'=>'栏目底下商品不为空'),
				'ORDER_STATUS_ERROR'			=> array('code'=>'4025' , 'msg'=>'订单状态错误'),
				'NO_HAVE_STORE'					=> array('code'=>'4026' , 'msg'=>'没有店铺'),
				'LOCATION_ERROR'				=> array('code'=>'4028' , 'msg'=>'定位失败'),
				'STORE_CLOSE'					=> array('code'=>'4026' , 'msg'=>'店铺未营业'),
				'HAVED_STORE'					=> array('code'=>'4029' , 'msg'=>'已经存在这个店铺名称了'),
				...
				'PAY_ERROR'						=> array('code'=>'5010' , 'msg'=>'支付金额异常'),

				'NO_BANK'						=> array('code'=>'5008' , 'msg'=>'没有银行信息'),
				'NO_TIMES'						=> array('code'=>'5009' , 'msg'=>'提现次数超过限制了'),
				'EXCEED_MONEY_LIMIT'			=> array('code'=>'5011' , 'msg'=>'超过金额限制了'),

				'REFUND_POINT_NOT_AMPLE'		=> array('code'=>'5012' , 'msg'=>'账户积分不足,退款失败'),

				'PAY_TYPE_ERROR'				=> array('code'=>'5013' , 'msg'=>'支付方式异常'),
				'PAY_TIME_OUT'					=> array('code'=>'5014' , 'msg'=>'支付超时'),
